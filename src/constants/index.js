import {
  ...
  const testimonials = [
    {
      testimonial:
        "Aldwin has very visible passion for his idea and it was great to witness his clarity of thoughts. He is also a good team player, ready to mould his skills if that helps him improve. These are some qualities that can go a long way in charting out a path towards success. I wish him the very best",
      name: "Khyati Bhatt",
      designation: "CEO",
    ...
    {
      testimonial:
        "I highly recommend Aldwin for any future endeavors. His dedication, hard work, and passion for his work are truly inspiring. Aldwin is a rare talent, and I am confident that he will continue to make great strides in his career and achieve even greater success in the future.",
      name: "Anup Robins",
  ...
  const projects = [
    ...
    },
    {
      ...
      image: jobit,
      source_code_link: "https://github.com/AldwinNegi/PredCo",
    },
    {
      name: "Prompt-X",
      description:
      ...
      image: tripguide,
      source_code_link: "https://github.com/AldwinNegi/Prompt-X-Website",
    },
  ];
